...
import { defineComponent, ref, computed, withCtx, unref, createVNode, openBlock, createBlock, Fragment, renderList, createTextVNode, toDisplayString, createCommentVNode, useSSRContext } from 'file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function togglePin(topic) {
      ...
      if ($firestore) {
        const { doc, updateDoc } = await import('file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/firebase/firestore/dist/index.mjs');
    ...
    async function deleteTopic(id) {
      ...
      if ($firestore) {
        const { doc, deleteDoc } = await import('file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/firebase/firestore/dist/index.mjs');
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-5"${_scopeId}><div${_scopeId}><h1 class="text-xl font-bold text-gray-900"${_scopeId}>Forum</h1><p class="text-sm text-gray-400 mt-0.5"${_scopeId}>Gestion des discussions de la communaut\xE9</p></div><div class="flex gap-1 bg-gray-100 rounded-xl p-1 w-fit"${_scopeId}><!--[-->`);
            ...
            return [
              createVNode("div", { class: "space-y-5" }, [
                createVNode("div", null, [
                  ...
                  createVNode("p", { class: "text-sm text-gray-400 mt-0.5" }, "Gestion des discussions de la communaut\xE9")
                ]),
                        ...
                        createVNode("div", { class: "flex-1 min-w-0" }, [
                          createVNode("div", { class: "flex items-center gap-2 flex-wrap mb-1" }, [
                            ...
                            topic.reported ? (openBlock(), createBlock("span", {
                              ...
                              createTextVNode(" Signal\xE9 ")
                            ])) : createCommentVNode("", true)
                          ]),
                          createVNode("p", { class: "font-medium text-gray-900 line-clamp-1" }, toDisplayString(topic.title), 1),
                          createVNode("p", { class: "text-xs text-gray-400 mt-0.5" }, toDisplayString((_a = topic.replyCount) != null ? _a : 0) + " r\xE9ponse" + toDisplayString(((_b = topic.replyCount) != null ? _b : 0) !== 1 ? "s" : "") + " \xB7 " + toDisplayString(formatDate(topic.createdAt)), 1)
                        ]),
...
//# sourceMappingURL=index-Cdq1H4at.mjs.map
