...
import { defineComponent, ref, computed, watch, withCtx, unref, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, withDirectives, isRef, vModelText, vModelSelect, createCommentVNode, useSSRContext } from 'file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const tabs = [{ key: "products", label: "Produits" }, { key: "events", label: "\xC9v\xE9nements" }];
    ...
    function statusBadge(s) {
      ...
      return (_a = m[s]) != null ? _a : "bg-gray-100 text-gray-500";
    }
    function statusLabel(s) {
      var _a;
      const m = { published: "Publi\xE9", draft: "Brouillon", archived: "Archiv\xE9", ended: "Termin\xE9" };
    ...
    const fallbackProducts = [
      ...
      { id: "2", name: "Semences de sorgho certifi\xE9es", category: "semences", price: 8e3, region: "Sahel", status: "published" },
      { id: "3", name: "Houe manga am\xE9lior\xE9e", category: "materiels", price: 15e3, region: "Hauts-Bassins", status: "draft" },
    ...
    async function loadItems() {
      ...
      loading.value = true;
      try {
        const { collection, query, orderBy, getDocs } = await import('file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/firebase/firestore/dist/index.mjs');
        const fs = $firestore;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-5"${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4"${_scopeId}><div${_scopeId}><h1 class="text-xl font-bold text-gray-900"${_scopeId}>Catalogue</h1><p class="text-sm text-gray-400 mt-0.5"${_scopeId}>Produits agricoles et \xE9v\xE9nements</p></div></div><div class="flex gap-1 bg-gray-100 rounded-xl p-1 w-fit"${_scopeId}><!--[-->`);
            ...
            if (unref(loading)) {
              ...
              if (unref(filteredItems).length === 0) {
                _push2(`<tr${_scopeId}><td colspan="4" class="px-5 py-10 text-center text-sm text-gray-400"${_scopeId}>Aucun \xE9l\xE9ment trouv\xE9.</td></tr>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</tbody></table>`);
...
//# sourceMappingURL=index-DYb6H3Dk.mjs.map
