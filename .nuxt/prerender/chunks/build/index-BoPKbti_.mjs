  ...
  setup(__props) {
    ...
    async function save(status) {
      ...
      try {
        ...
        if ($firestore) {
          const { doc, updateDoc, addDoc, collection, serverTimestamp } = await import('file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/firebase/firestore/dist/index.mjs');
          const fs = $firestore;
          if (editingId.value) {
    ...
    function typeLabel(t) {
      var _a;
      const m = { news: "Actualit\xE9", advice: "Conseil", alert: "Alerte", announcement: "Annonce" };
...
//# sourceMappingURL=index-BoPKbti_.mjs.map
