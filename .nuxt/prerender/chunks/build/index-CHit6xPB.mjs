import { _ as __nuxt_component_0, a as __nuxt_component_1, b as _sfc_main$2$1 } from './AppFooter-D-SWLKRv.mjs';
import { defineComponent, mergeProps, ref, h, createVNode, resolveDynamicComponent, useSSRContext } from 'file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrRenderVNode } from 'file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const stats = [
      { value: "17", label: "R\xE9gions couvertes" },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-gradient-to-br from-tertiary to-white" }, _attrs))}><header class="pt-24 pb-16 px-6 flex flex-col md:flex-row items-center gap-10 max-w-6xl mx-auto"><div class="flex-1"><h1 class="text-primary text-6xl font-semibold leading-tight mb-1">Faso Agri</h1><p class="text-secondary text-2xl font-medium mb-5 leading-snug"> Vendez, achetez et interagisseez avec les acteurs des secteurs agro-pastoraux.<br>Depuis votre localit\xE9. </p><p class="text-gray-500 text-md leading-relaxed mb-7"> Producteurs, \xE9leveurs, acteurs du secteur - trouvez des acheteurs, des v\xE9t\xE9rinaires et les bons prix du march\xE9. Tout \xE7a depuis votre t\xE9l\xE9phone, partout au Burkina Faso. </p><button class="bg-primary text-white px-7 py-3 rounded-lg text-base font-medium hover:bg-secondary transition-colors duration-300"> T\xE9l\xE9charger gratuitement </button><div class="flex gap-8 pt-6 mt-6 border-t border-gray-100"><!--[-->`);
      ...
      ssrRenderList(screenshots, (_, i) => {
        _push(`<button${ssrRenderAttr("aria-label", `Aller \xE0 la capture d'\xE9cran ${i + 1}`)} class="${ssrRenderClass([i === currentIndex.value ? "bg-primary" : "bg-gray-300 hover:bg-secondary", "w-2 h-2 rounded-full transition-all duration-300"])}"></button>`);
      });
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const features = [
      {
        title: "March\xE9 agricole",
        description: "Achetez et vendez vos produits entre producteurs et acheteurs.",
        iconBg: "bg-green-100",
        icon: IconMarche
      },
      {
        title: "\xC9v\xE9nements",
        description: "D\xE9couvrez foires, formations et rencontres agricoles.",
        iconBg: "bg-amber-100",
        icon: IconEvenements
      },
      {
        title: "Annuaire",
        description: "Trouvez v\xE9t\xE9rinaires, fournisseurs et techniciens pr\xE8s de chez vous.",
        iconBg: "bg-emerald-100",
        icon: IconAnnuaire
      },
      {
        title: "Astuces & conseils",
        description: "Guides techniques, conseils et forum d'\xE9change.",
        iconBg: "bg-blue-100",
        icon: IconInfos
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="max-w-6xl mx-auto"><div class="text-sm font-semibold text-primary uppercase tracking-wider mb-2"> Ce que vous pouvez faire </div><h2 class="text-3xl font-semibold mb-2">Tout ce dont un acteur du secteur agro-pastoral, ou un amateur a besoin</h2><p class="text-gray-500 mb-9">Quatre modules con\xE7us pour le terrain burkinab\xE8</p><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4"><!--[-->`);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const points = [
      "Interface simple, et fluidifi\xE9e pour les utilisateurs de tous \xE2ges",
      "Donn\xE9es locales : prix du march\xE9, professionnels proches",
      "100% gratuit",
      "100% burkinab\xE8, pour les acteurs locaux"
    ];
    const stats = [
      { value: "17", label: "R\xE9gions du Burkina Faso" },
      { value: "4", label: "Modules disponibles" },
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))}><div class="max-w-2xl mx-auto"><h2 class="text-3xl font-semibold text-white mb-2">Pr\xEAt \xE0 rejoindre Faso Agri ?</h2><p class="text-white/80 mb-7">T\xE9l\xE9chargez l&#39;application et connectez-vous \xE0 la de cha\xEEne de valeur agro-pastorale</p><div class="flex gap-4 justify-center flex-wrap"><a href="#" class="bg-white px-5 py-3 rounded-xl flex items-center gap-2.5 hover:opacity-90 transition-opacity"><svg class="w-6 h-6" viewBox="0 0 24 24" fill="black"><path d="M3 20.5v-17l18 8.5-18 8.5z"></path></svg><div class="text-left"><div class="text-[10px] text-gray-500">Disponible sur</div><div class="text-sm font-semibold">Google Play</div></div></a><a href="#" class="bg-white px-5 py-3 rounded-xl flex items-center gap-2.5 hover:opacity-90 transition-opacity"><svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="1.5"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path></svg><div class="text-left"><div class="text-[10px] text-gray-500">T\xE9l\xE9charger l&#39;</div><div class="text-sm font-semibold">APK direct</div></div></a></div></div></section>`);
}
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      title: "Faso Agri - Le r\xE9seau social de cha\xEEne de valeur agro-pastorale",
      description: "Faso Agri connecte producteurs, \xE9leveurs, acheteurs et professionnels de l'agriculture burkinab\xE8 en un seul endroit.",
...
//# sourceMappingURL=index-CHit6xPB.mjs.map
