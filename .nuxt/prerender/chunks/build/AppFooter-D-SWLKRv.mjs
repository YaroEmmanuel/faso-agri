import { _ as __nuxt_component_0$1 } from './nuxt-link-CkXNCsDJ.mjs';
import { mergeProps, withCtx, createVNode, computed, ref, useAttrs, useTemplateRef, createTextVNode, useSSRContext } from 'file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot } from 'file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/defu/dist/defu.mjs';
import { hasProtocol, withLeadingSlash, joinURL, parseURL, encodeParam, encodePath } from 'file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/ufo/dist/index.mjs';
import { appendHeader } from 'file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/h3/dist/index.mjs';
import { _ as _export_sfc, c as useRequestEvent, u as useNuxtApp, b as useRuntimeConfig } from './server.mjs';
import { a as useHead } from './v3-BR0C_1wp.mjs';
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file://C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const ipxStaticRuntime$ml0zEz_45ZgsXVxqWEw5e8L9kmHsX76PVTdqI2_xL_mlo = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipxStatic",
  providers: {
    ["ipxStatic"]: { setup: ipxStaticRuntime$ml0zEz_45ZgsXVxqWEw5e8L9kmHsX76PVTdqI2_xL_mlo, defaults: {} }
  }
};
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<nav${ssrRenderAttrs(mergeProps({ class: "fixed top-0 w-full bg-white border-b border-gray-200 z-50 py-1" }, _attrs))}><div class="flex items-center px-1 max-w-6xl mx-auto justify-between"><div>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<span class="text-lg font-bold text-black hidden md:block"${_scopeId}> Faso Agri </span>`);
      } else {
        return [
          ...
          createVNode("span", { class: "text-lg font-bold text-black hidden md:block" }, " Faso Agri ")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</div><div class="flex gap-6 items-center"><div class="text-black text-md md:flex gap-4 hidden"><a href="#features" class="hover:text-primary">Fonctionnalit\xE9s</a><a href="#about" class="hover:text-primary">Pourquoi Faso Agri</a><a href="#contact" class="hover:text-primary">Contact</a></div><button class="bg-primary text-white px-5 py-2 rounded-md text-sm hover:bg-secondary transition-colors duration-300"> T\xE9l\xE9charger </button></div></div></nav>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/landing/AppNav.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-primary py-5 px-6 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4" }, _attrs))}><div class="text-xs text-white">\xA9 2026 Faso Agri. Tous droits r\xE9serv\xE9s.</div><div class="flex gap-5 text-xs text-white"><a href="mailto:contact@ytech-bf.com" class="hover:text-white/70 transition-colors">Contacts</a>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/confidentialite",
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Confidentialit\xE9s `);
      } else {
        return [
          createTextVNode(" Confidentialit\xE9s ")
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/landing/AppFooter.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { __nuxt_component_0 as _, __nuxt_component_1 as a, _sfc_main$2 as b };
//# sourceMappingURL=AppFooter-D-SWLKRv.mjs.map
