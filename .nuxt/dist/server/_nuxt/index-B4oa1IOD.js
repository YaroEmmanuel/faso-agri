    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-5"${_scopeId}><div${_scopeId}><h1 class="text-xl font-semibold text-gray-900"${_scopeId}>Forum</h1><p class="text-sm text-gray-400 mt-0.5"${_scopeId}>Modération des discussions</p></div><div class="flex gap-1 bg-gray-100 rounded-xl p-1 w-fit"${_scopeId}><!--[-->`);
            ...
            if (unref(activeTab) === "topics") {
              ...
              ssrRenderList(unref(topics), (topic) => {
                ...
                if (topic.status === "pinned") {
                  _push2(`<span class="text-xs bg-primary/10 text-primary px-2 py-0.5 rounded-full font-medium"${_scopeId}>📌 Épinglé</span>`);
                } else {
                  _push2(`<!---->`);
                }
                if (topic.status === "closed") {
                  _push2(`<span class="text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full font-medium"${_scopeId}>🔒 Fermé</span>`);
                } else {
                  _push2(`<!---->`);
                }
                if (topic.reported) {
                  _push2(`<span class="text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full font-medium"${_scopeId}>⚠️ Signalé</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
            ...
            return [
              createVNode("div", { class: "space-y-5" }, [
                createVNode("div", null, [
                  ...
                  createVNode("p", { class: "text-sm text-gray-400 mt-0.5" }, "Modération des discussions")
                ]),
                      ...
                      createVNode("div", { class: "flex items-start justify-between gap-4" }, [
                        createVNode("div", { class: "flex-1 min-w-0" }, [
                          createVNode("div", { class: "flex items-center gap-2 flex-wrap mb-1" }, [
                            ...
                            }, "📌 Épinglé")) : createCommentVNode("", true),
                          ...
                          createVNode("p", { class: "text-xs text-gray-400 mt-0.5" }, toDisplayString(topic.replyCount) + " réponse" + toDisplayString(topic.replyCount !== 1 ? "s" : "") + " · " + toDisplayString(formatDate(topic.createdAt)), 1)
                        ]),
...
//# sourceMappingURL=index-B4oa1IOD.js.map
