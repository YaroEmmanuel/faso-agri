...
import { defineComponent, ref, computed, watch, withCtx, unref, openBlock, createBlock, createVNode, createTextVNode, Fragment, renderList, toDisplayString, withDirectives, isRef, vModelText, vModelSelect, createCommentVNode, useSSRContext } from "vue";
...
import { query, collection, orderBy, getDocs, updateDoc, doc } from "firebase/firestore";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-5"${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4"${_scopeId}><div${_scopeId}><h1 class="text-xl font-semibold text-gray-900"${_scopeId}>Catalogue</h1><p class="text-sm text-gray-400 mt-0.5"${_scopeId}>Produits agricoles et événements</p></div>`);
            ...
            if (unref(loading)) {
              ...
              ssrRenderList(unref(filteredItems), (item) => {
                ...
                if (item.imageBase64) {
                  ...
                  _push2(`<div class="w-full h-full flex items-center justify-center text-lg"${_scopeId}>${ssrInterpolate(unref(activeTab) === "products" ? "🌾" : "📅")}</div>`);
                }
              ...
              if (unref(filteredItems).length === 0) {
                _push2(`<tr${_scopeId}><td colspan="5" class="px-5 py-10 text-center text-sm text-gray-400"${_scopeId}> Aucun élément trouvé. </td></tr>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</tbody></table>`);
                          ...
                          createVNode("td", { class: "px-5 py-3.5" }, [
                            createVNode("div", { class: "flex items-center gap-3" }, [
                              createVNode("div", { class: "w-10 h-10 rounded-xl bg-gray-100 flex-shrink-0 overflow-hidden" }, [
                                ...
                                }, toDisplayString(unref(activeTab) === "products" ? "🌾" : "📅"), 1))
                              ]),
...
//# sourceMappingURL=index-DTSDqt5R.js.map
