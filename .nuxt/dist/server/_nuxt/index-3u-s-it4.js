import { _ as _sfc_main$2 } from "./AdminLayout-Ah3JggTO.js";
import { defineComponent, h, computed, mergeProps, unref, createVNode, resolveDynamicComponent, useSSRContext, ref, withCtx, createTextVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderClass, ssrRenderVNode, ssrRenderComponent, ssrRenderList } from "vue/server-renderer";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const stats = computed(() => [
      ...
      { label: "Événements", value: globalStats.value.totalEvents, iconKey: "events" },
    ...
    function badgeClass(type) {
      return typeConfig[type]?.badge ?? "bg-gray-100 text-gray-500";
    }
    function dotClass(type) {
      return typeConfig[type]?.dot ?? "bg-gray-300";
    }
    return (_ctx, _push, _parent, _attrs) => {
              ...
              createVNode("div", { class: "space-y-7" }, [
                ...
                createVNode("div", { class: "bg-white rounded-2xl border border-gray-100 overflow-hidden" }, [
                  createVNode("div", { class: "px-6 py-4 border-b border-gray-100 flex items-center justify-between" }, [
                    createVNode("div", null, [
                      createVNode("h2", { class: "text-sm font-semibold text-gray-900" }, "Dernières publications"),
                      createVNode("p", { class: "text-xs text-gray-400 mt-0.5" }, "5 publications récentes de la plateforme")
                    ]),
...
//# sourceMappingURL=index-3u-s-it4.js.map
