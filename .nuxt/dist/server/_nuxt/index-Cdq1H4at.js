...
import { defineComponent, ref, computed, withCtx, unref, createVNode, openBlock, createBlock, Fragment, renderList, createTextVNode, toDisplayString, createCommentVNode, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-5"${_scopeId}><div${_scopeId}><h1 class="text-xl font-bold text-gray-900"${_scopeId}>Forum</h1><p class="text-sm text-gray-400 mt-0.5"${_scopeId}>Gestion des discussions de la communauté</p></div><div class="flex gap-1 bg-gray-100 rounded-xl p-1 w-fit"${_scopeId}><!--[-->`);
            ...
            if (unref(activeTab) === "topics") {
              ...
              ssrRenderList(unref(topics), (topic) => {
                ...
                if (topic.status === "pinned") {
                  _push2(`<span class="inline-flex items-center gap-1 text-xs bg-primary/10 text-primary px-2 py-0.5 rounded-full font-medium"${_scopeId}><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 24 24"${_scopeId}><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"${_scopeId}></path></svg> Épinglé </span>`);
                } else {
                  _push2(`<!---->`);
                }
                if (topic.status === "closed") {
                  _push2(`<span class="inline-flex items-center gap-1 text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full font-medium"${_scopeId}><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"${_scopeId}></path></svg> Fermé </span>`);
                } else {
                  _push2(`<!---->`);
                }
                if (topic.reported) {
                  _push2(`<span class="inline-flex items-center gap-1 text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full font-medium"${_scopeId}><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"${_scopeId}></path></svg> Signalé </span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><p class="font-medium text-gray-900 line-clamp-1"${_scopeId}>${ssrInterpolate(topic.title)}</p><p class="text-xs text-gray-400 mt-0.5"${_scopeId}>${ssrInterpolate(topic.replyCount ?? 0)} réponse${ssrInterpolate((topic.replyCount ?? 0) !== 1 ? "s" : "")} · ${ssrInterpolate(formatDate(topic.createdAt))}</p></div><div class="flex items-center gap-1 flex-shrink-0"${_scopeId}><button${ssrRenderAttr("title", topic.status === "pinned" ? "Désépingler" : "Épingler")} class="p-2 rounded-lg hover:bg-gray-100 transition text-gray-400 hover:text-gray-700"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"${_scopeId}></path></svg></button><button${ssrRenderAttr("title", topic.status === "closed" ? "Rouvrir" : "Fermer")} class="p-2 rounded-lg hover:bg-gray-100 transition text-gray-400 hover:text-gray-700"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"${_scopeId}></path></svg></button><button title="Supprimer" class="p-2 rounded-lg hover:bg-red-50 transition text-gray-400 hover:text-red-500"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"${_scopeId}></path></svg></button></div></div></div>`);
              });
              _push2(`<!--]-->`);
            ...
            if (unref(activeTab) === "reported") {
              ...
              ssrRenderList(unref(reportedItems), (item) => {
                _push2(`<div class="bg-white rounded-2xl border border-red-100 p-4"${_scopeId}><div class="flex items-start justify-between gap-4"${_scopeId}><div class="flex-1 min-w-0"${_scopeId}><p class="text-xs text-red-500 font-medium mb-1 uppercase tracking-wide"${_scopeId}>${ssrInterpolate(item.type === "topic" ? "Sujet" : "Réponse")}</p><p class="text-sm text-gray-800 line-clamp-2"${_scopeId}>${ssrInterpolate(item.content)}</p></div><button class="text-xs text-red-500 hover:text-red-700 border border-red-200 rounded-lg px-3 py-1.5 hover:bg-red-50 transition flex-shrink-0"${_scopeId}> Supprimer </button></div></div>`);
              });
              _push2(`<!--]-->`);
              if (unref(reportedItems).length === 0) {
                _push2(`<p class="text-center text-sm text-gray-400 py-10"${_scopeId}>Aucun contenu signalé.</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            return [
              createVNode("div", { class: "space-y-5" }, [
                createVNode("div", null, [
                  createVNode("h1", { class: "text-xl font-bold text-gray-900" }, "Forum"),
                  createVNode("p", { class: "text-sm text-gray-400 mt-0.5" }, "Gestion des discussions de la communauté")
                ]),
                          ...
                          createVNode("div", { class: "flex items-center gap-2 flex-wrap mb-1" }, [
                            topic.status === "pinned" ? (openBlock(), createBlock("span", {
                              ...
                              (openBlock(), createBlock("svg", {
                                ...
                                createVNode("path", { d: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" })
                              ])),
                              createTextVNode(" Épinglé ")
                            ])) : createCommentVNode("", true),
                            topic.status === "closed" ? (openBlock(), createBlock("span", {
                              key: 1,
                              class: "inline-flex items-center gap-1 text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full font-medium"
                            }, [
                              (openBlock(), createBlock("svg", {
                                class: "w-3 h-3",
                                fill: "none",
                              ...
                              createTextVNode(" Fermé ")
                            ])) : createCommentVNode("", true),
                            topic.reported ? (openBlock(), createBlock("span", {
                              key: 2,
                              class: "inline-flex items-center gap-1 text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full font-medium"
                            }, [
                              (openBlock(), createBlock("svg", {
                                class: "w-3 h-3",
                                fill: "none",
                              ...
                              createTextVNode(" Signalé ")
                            ])) : createCommentVNode("", true)
                          ]),
                          createVNode("p", { class: "font-medium text-gray-900 line-clamp-1" }, toDisplayString(topic.title), 1),
                          createVNode("p", { class: "text-xs text-gray-400 mt-0.5" }, toDisplayString(topic.replyCount ?? 0) + " réponse" + toDisplayString((topic.replyCount ?? 0) !== 1 ? "s" : "") + " · " + toDisplayString(formatDate(topic.createdAt)), 1)
                        ]),
                ...
                unref(activeTab) === "reported" ? (openBlock(), createBlock("div", {
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(unref(reportedItems), (item) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-start justify-between gap-4" }, [
                        createVNode("div", { class: "flex-1 min-w-0" }, [
                          createVNode("p", { class: "text-xs text-red-500 font-medium mb-1 uppercase tracking-wide" }, toDisplayString(item.type === "topic" ? "Sujet" : "Réponse"), 1),
                  ...
                  unref(reportedItems).length === 0 ? (openBlock(), createBlock("p", {
                    key: 0,
                    class: "text-center text-sm text-gray-400 py-10"
                  }, "Aucun contenu signalé.")) : createCommentVNode("", true)
                ])) : createCommentVNode("", true)
              ])
            ];
          }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/forum/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=index-Cdq1H4at.js.map
