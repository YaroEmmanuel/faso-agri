import { _ as __nuxt_component_0$1 } from "./nuxt-link-CkXNCsDJ.js";
import { computed, ref, useAttrs, useTemplateRef, mergeProps, useSSRContext, withCtx, createVNode, createTextVNode } from "vue";
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent } from "vue/server-renderer";
import { defu } from "C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/defu/dist/defu.mjs";
import { hasProtocol, withLeadingSlash, joinURL, parseURL, encodeParam, encodePath } from "C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/ufo/dist/index.mjs";
import { appendHeader } from "C:/Users/emmay/Documents/GitHub/extra/faso-agri-nuxt/node_modules/h3/dist/index.mjs";
import { u as useNuxtApp, b as useRuntimeConfig, c as useRequestEvent, _ as _export_sfc } from "../server.mjs";
import { u as useHead } from "./v3-BR0C_1wp.js";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><div class="flex gap-6 items-center"><div class="text-black text-md md:flex gap-4 hidden"><a href="#features" class="hover:text-primary">Fonctionnalités</a><a href="#about" class="hover:text-primary">Pourquoi Faso Agri</a><a href="#contact" class="hover:text-primary">Contact</a></div><button class="bg-primary text-white px-5 py-2 rounded-md text-sm hover:bg-secondary transition-colors duration-300"> Télécharger </button></div></div></nav>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-primary py-5 px-6 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4" }, _attrs))}><div class="text-xs text-white">© 2026 Faso Agri. Tous droits réservés.</div><div class="flex gap-5 text-xs text-white"><a href="mailto:contact@ytech-bf.com" class="hover:text-white/70 transition-colors">Contacts</a>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/confidentialite",
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Confidentialités `);
      } else {
        return [
          createTextVNode(" Confidentialités ")
        ];
      }
    }),
    _: 1
...
//# sourceMappingURL=AppFooter-D-SWLKRv.js.map
